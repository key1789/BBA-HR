...
export function DirectEditModal({
  ...
  // The overlay is rendered via a portal so its <form> is mounted directly on
  // document.body, NOT inside the parent desktop table <form>. This avoids the
  // HTML violation "form cannot be a descendant of form."
  const overlay = open ? (
