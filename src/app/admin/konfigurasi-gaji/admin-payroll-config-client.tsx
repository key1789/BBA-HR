...
function CrewCard({
  ...
  return (
    <div className={cn(
      "bg-white border rounded-3xl overflow-hidden shadow-sm transition-colors",
      isDirty ? "border-amber-300" : isConfigured ? "border-slate-100" : "border-amber-200/80",
    )}>
      ...
      >
        <div className="flex items-center gap-3">
          <div className={cn(
            ...
            <User size={14} className={isConfigured ? "text-sky-500" : "text-amber-500"} />
          </div>
          <div>
        ...
        <div className="border-t border-slate-100 px-4 py-4 space-y-5">
          ...
          <div className="bg-sky-600 rounded-2xl px-4 py-3 flex items-center justify-between shadow-lg shadow-sky-600/20">
            <div className="flex items-center gap-2">
              <Banknote size={16} className="text-sky-200 shrink-0" />
              <div>
                <p className="text-[9px] font-black uppercase tracking-widest text-sky-200">Estimasi THP</p>
                <p className="text-[9px] text-sky-300 font-medium">*Makan & Transport dikali hari masuk</p>
              </div>
            </div>
...
export function AdminPayrollConfigClient({ tenantId, crew, saveAction }: Props) {
