...
export default async function OwnerDataKaryawanPage({
  searchParams,
}: {
  ...
  return (
    <AnimatedPage>
      <OwnerPortalShell
        ctx={ctx}
        basePath="/owner/data-karyawan"
        title={
          <>
            Data per <span className="text-amber-600">karyawan</span>
          </>
        }
      ...
      >
        <AuditDetailClient
          ...
          ownerNavBasePath="/owner/data-karyawan"
        />
      </OwnerPortalShell>
    </AnimatedPage>
  );
