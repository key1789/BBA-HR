    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="bg-sky-600 p-8 text-white text-center">
          ...
          <p className="text-sky-100 mt-2 text-sm opacity-90">Lengkapi data akun Owner Anda.</p>
        </div>
        ...
        <form action={action} className="p-8 space-y-6">
          ...
          <div className="space-y-4">
            {/* Nama lengkap — editable, pre-filled dari undangan */}
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-[10px] text-slate-400 italic">*Email ini akan digunakan untuk login.</p>
            </div>

            {/* Nomor WA */}
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                <Phone size={12} /> Nomor HP / WA
              </label>
              <input
                type="tel"
                name="phone"
