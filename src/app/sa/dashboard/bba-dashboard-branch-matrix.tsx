      ...
      <div className="overflow-x-auto rounded-xl border border-slate-100">
        <table className="min-w-full text-left">
          <thead className="bg-slate-50 text-[9px] font-black text-slate-400 uppercase tracking-widest">
            <tr>
              <MatrixTh col="tenantCode" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Kode</MatrixTh>
              <th className="px-4 py-3 hidden sm:table-cell text-[9px] font-black text-slate-400 uppercase tracking-widest">
                Nama
              </th>
              <MatrixTh col="todayStatus" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Hari Ini</MatrixTh>
              <MatrixTh col="mtdPct" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>MTD%</MatrixTh>
              <MatrixTh col="openQueue" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Queue</MatrixTh>
              <MatrixTh col="overdueQueue" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Overdue</MatrixTh>
              <MatrixTh col="pendingLeave" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Izin</MatrixTh>
              <MatrixTh col="pendingSwap" sortKey={sortKey} sortDir={sortDir} onSort={handleSort}>Swap</MatrixTh>
