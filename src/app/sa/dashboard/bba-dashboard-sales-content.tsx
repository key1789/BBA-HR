...
function ModalSortIcon({ col, modalSort, modalDir }: { col: ModalSortKey; modalSort: ModalSortKey; modalDir: "asc" | "desc" }) {
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Link
                href={`/sa/audit?tenant=${selectedBranch.tenantId}`}
                  ...
                  {selectedBranch.monthlyData.length === 0 ? (
                    ...
                    [...selectedBranch.monthlyData].reverse().map((p) => (
                      <tr key={p.yearMonth} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-5 py-3">
                          <Link
                            href={`/sa/audit?tenant=${selectedBranch.tenantId}&month=${p.month}&year=${p.year}`}
                ...
                <thead className="sticky top-0 bg-slate-50 text-[9px] font-black text-slate-400 uppercase tracking-widest z-10">
                  <tr>
                    ...
                    <th className="px-5 py-3">
                      ...
                      >
                        Avg Capaian <ModalSortIcon col="capaian" modalSort={modalSort} modalDir={modalDir} />
                      </button>
                    </th>
                    <th className="px-5 py-3">
                      <button
                        ...
                        className="flex items-center gap-1 hover:text-slate-600"
                      >
                        Total Omzet <ModalSortIcon col="omzet" modalSort={modalSort} modalDir={modalDir} />
                      </button>
                    </th>
